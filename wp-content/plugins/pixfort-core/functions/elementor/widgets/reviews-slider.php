...
class Pix_Eor_Reviews_Slider extends Widget_Base {
	...
	public function __construct($data = [], $args = null) {
		...
		wp_register_script( 'pix-reviews-slider-handle', PIX_CORE_PLUGIN_URI.'functions/elementor/js/reviews-slider.js', [ 'elementor-frontend', 'pix-main-essentials' ], PIXFORT_PLUGIN_VERSION, true );
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'rating', [
				'label' => __( 'Rating', 'essentials-core' ),
		...
		$this->add_control(
			'bold',
			[
				'label' => __( 'Bold Name', 'essentials-core' ),
		...
		$this->add_control(
			'italic',
			[
				'label' => __( 'Italic Name', 'essentials-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'essentials-core' ),
				'label_off' => __( 'No', 'essentials-core' ),
		...
		$this->add_control(
			'secondary_font',
			[
				'label' => __( 'Secondary font Name', 'essentials-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'essentials-core' ),
				'label_off' => __( 'No', 'essentials-core' ),
		...
		$this->add_control(
			'content_bold',
			[
				'label' => __( 'Bold Content', 'essentials-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'essentials-core' ),
				'label_off' => __( 'No', 'essentials-core' ),
				'return_value' => 'font-weight-bold',
		...
		$this->add_control(
			'content_italic',
			[
				'label' => __( 'Italic Content', 'essentials-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'essentials-core' ),
				'label_off' => __( 'No', 'essentials-core' ),
				'return_value' => 'font-italic',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Secondary font Content', 'essentials-core' ),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'label_on' => __( 'Yes', 'essentials-core' ),
				'label_off' => __( 'No', 'essentials-core' ),
				'return_value' => 'secondary-font',
		...
		$this->start_controls_section(
			'section_styling',
			[
				'label' => __( 'Styling', 'essentials-core' ),
