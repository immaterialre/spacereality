...
class Pix_Eor_Dividers extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'd_color_1', [
				'label' => __( 'Layer color', 'plugin-name' ),
		...
		$repeater->add_control(
			'd_color_2', [
				'label' => __( 'Layer color 2', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#f8f9fa',
				'condition' => [
					'd_gradient!' => '',
		...
		$this->add_control(
			'b_1_color',
			[
				'label' => __( 'Layer 1 color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#ffffff',
				// 'condition' => [
				// 	'icon_color' => 'custom',
		...
		$this->add_control(
			'b_1_color_2',
			[
				'label' => __( 'Layer 1 second gradient color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#ffffff',
				'condition' => [
					'b_1_is_gradient!' => '',
		...
		$this->add_control(
			'b_2_color',
			[
				'label' => __( 'Layer 2 color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_control(
			'b_2_color_2',
			[
				'label' => __( 'Layer 2 second gradient color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#ffffff',
				'condition' => [
					'b_2_is_gradient!' => '',
		...
		$this->add_control(
			'b_3_color',
			[
				'label' => __( 'Layer 3 color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_control(
			'b_3_color_2',
			[
				'label' => __( 'Layer 3 second gradient color', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#ffffff',
				'condition' => [
					'b_3_is_gradient!' => '',
