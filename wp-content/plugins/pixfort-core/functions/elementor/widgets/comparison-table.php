...
class Pix_Eor_Comparison_Table extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'col_2_text', [
				'label' => __( 'Column 2 Text', 'essentials-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '' , 'essentials-core' ),
			]
		);
		$repeater->add_control(
			'col_2_tooltip', [
				'label' => __( 'Col 2 Tooltip', 'essentials-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '' , 'essentials-core' ),
			]
		);
		$repeater->add_control(
			'col_2_media_type', [
				'label' => __( 'Column 2 Icon', 'essentials-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => array_flip(array(
					"None" => "none",
		...
		$repeater->add_control(
			'col_3_text', [
				'label' => __( 'Column 3 Text', 'essentials-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '' , 'essentials-core' ),
			]
		);
		$repeater->add_control(
			'col_3_tooltip', [
				'label' => __( 'Col 3 Tooltip', 'essentials-core' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( '' , 'essentials-core' ),
			]
		);
		$repeater->add_control(
			'col_3_media_type', [
				'label' => __( 'Column 3 Icon', 'essentials-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'none',
				'options' => array_flip(array(
					"None" => "none",
