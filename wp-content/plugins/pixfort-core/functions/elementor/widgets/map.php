...
class Pix_Eor_Map extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'custom_color',
			[
				'label' => __( 'Custom color', 'plugin-name' ),
		...
		$this->add_control(
			'custom_saturation',
			[
				'label' => __( 'Custom saturation', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '-20',
				'condition' => [
					'map_style' => 'custom',
		...
		$this->add_control(
			'custom_brightness',
			[
				'label' => __( 'Custom brightness', 'plugin-name' ),
				'type' => \Elementor\Controls_Manager::TEXT,
				'default' => '5',
				'condition' => [
					'map_style' => 'custom',
		...
		$this->add_control(
			'marker',
			[
				'label' => __( 'Marker Image', 'plugin-name' ),
