	...
	if($show){
	 ...
	 <div class="pix-pl-10 align-self-stretch d-flex">
		 ...
		 if($product->is_type( 'variable' )){
			 ...
			 ?>
			 <span data-toggle="tooltip" data-placement="bottom" title="<?php echo esc_attr__('Out of stock', 'essentials'); ?>" class="<?php echo esc_attr( $icon_class ); ?>"><span class="btn-icon text-18 <?php echo esc_attr( $icon_class ); ?> pixicon-cart-remove align-self-center"></span></span>
			 <?php
		 }else{
			 ?>
			 	<a href="#" data-link="<?php echo esc_attr( $add_link ); ?>" class="pix-add-to-cart <?php echo esc_attr( $icon_class ); ?>" data-product_id="<?php echo esc_attr( $post->ID ); ?>" data-name="<?php echo esc_attr( $product->get_name() );?>" data-img="<?php echo esc_attr( $image ); ?>">
					<span class="btn-icon text-18 <?php echo esc_attr( $icon_class ); ?> pixicon-bag-2 align-self-center"></span>
				</a>
			 <?php
		 }
		 ?>
