	...
	$fields = array(
		...
		'pix_column_section'		=> array(
			...
			'pix_columns_number'		=> array(
					'label' => esc_attr__( 'Number columns ', 'essentials' ),
					'element' => 'select',
					'options' => array(
						'2' => esc_attr__( '2 columns', 'essentials' ),
						'3' => esc_attr__( '3 columns', 'essentials' ),
						'4' => esc_attr__( '4 columns', 'essentials' ),
						'6' => esc_attr__( '6 columns', 'essentials' ),
						'12' => esc_attr__( '12 columns', 'essentials' ),
					),
					'classes'	=> 'pix-dropdown-opt pix-column-opt'
			),
