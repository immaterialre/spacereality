               ...
               // if(data.length>0&&data!=""){
                   ...
                   $.each(data,function(i, f){
                       ...
                       var item = '<div class="pix-multifields-item">';
                               ...
                               item += '<input class="pix_item_value pix_fields_field" type="text" placeholder="Value" value="" />';
                               item += '<a href="#" class="pix_field_remove">Delete</a>';
                            item += '</div>';
                            let el=$(item);
                            el.find('.pix_item_value').val(value);
                            console.log(el);
                       field.find('.pix-multi-fields-input').append(el);
                   });
