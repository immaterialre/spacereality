(function($){
    ...
    jQuery(document).ready(function($) {
        ...
        if(isSafari){
            ...
            // $('.sticky-top').each(function(i, el){
            //     let pw = $(el).parent().outerWidth();
            //     $(el).css({
            //         'width': pw + ' !important'
            //     });
            //     let instance = $(el).stickybits( { useFixed: true });
            //     instance.update();
            //     // $(el).closest('section').removeClass('vc_section_visible').addClass('overflow-x-clip');
            //     // $(el).css({
            //     //     ''
            //     // })
            // });
        ...
        $('body').on('click', 'a', function(event){
            ...
            if(link!== 'undefined' && link != undefined){
                ...
                if( link && link.startsWith('#pix_popup_') ){
                    event.preventDefault();
                ...
                if( link && link.startsWith('#pix-tab-') && !$(this).hasClass('pix-tabs-btn') ){
                    if($(link).length){
                        event.stopPropagation();
                        event.preventDefault();
